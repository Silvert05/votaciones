...
const generatePalette = require(
    path.resolve(__dirname, 'src/@core/tailwind/utils/generate-palette')
);

const customPalettes = {
    brand: generatePalette('#28367F'),
};
...
const config = {
    ...
    plugins: [
        ...
        require(
            path.resolve(__dirname, 'src/@core/tailwind/plugins/utilities')
        ),
        require(
            path.resolve(__dirname, 'src/@core/tailwind/plugins/icon-size')
        ),
